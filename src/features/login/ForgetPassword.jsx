...
export default function ForgetPassword() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        import.meta.env.VITE_EMAILJS_TEMPLATE_FORGOTPW_ID,
        templateParams,
  ...
  return (
    <div className="relative z-10 w-full max-w-md p-8 mx-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl text-white">
      ...
      {step === 2 && (
        <form onSubmit={handleFinalSubmit} className="space-y-5">
          <div
            className={
              "flex items-center justify-center gap-2 py-2 rounded-lg border text-sm font-mono transition-colors"
            }
          >
            <Timer size={16} />
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <ShieldCheck
                className="absolute right-3 top-3.5 opacity-40"
                size={18}
              />
            </div>
          </div>
      ...
      <div className="flex gap-6 justify-center mt-8 text-center text-sm">
        <button
          ...
          className={
            "text-white font-semibold hover:text-blue-600 cursor-pointer"
          }
        >
          Gửi lại mã
        </button>
