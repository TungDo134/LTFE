  ...
  return (
    <div className="transition-all duration-200">
      <div
        ...
        className={`p-3 flex items-center gap-4 border-white border-2 border-b-0 cursor-pointer
      ...
      {isSelected && (
        <div className="p-4 border-white border-2 border-t-0 bg-white flex flex-col items-start gap-3">
